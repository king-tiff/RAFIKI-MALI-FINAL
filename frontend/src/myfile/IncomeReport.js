...
function IncomeReport() {
  ...
  useEffect(() => {
    const apiUrl = `http://localhost:2003/api/income-report/${userId}`;
    ...
    <div className="main-wrapper">
      ...
      <div className="row" style={{ marginTop: '40px' }}>
        ...
        <div className="col-sm-9">
          ...
          <div className="row">
            <div className="col">
              <p className="h1">Income report</p>
            </div>
            <div className="col">
            ...
            <div className="col-sm-6">
              <div className="form-group">
                <input
                  ...
                  placeholder="Filter by Income Source"
                  value={filter}
          ...
          <div>
            {loading ? (
              ...
              <table className="table table-hover table-center mb-0">
                ...
                <tbody>
                  {sortedData
                    .filter((row) => row.source.includes(filter))
                    .map((row) => (
                      <tr key={row.id}>
                        <td>{row.id}</td>
                        <td>{row.source}</td>
